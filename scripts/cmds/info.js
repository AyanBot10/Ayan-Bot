...
module.exports = {
  ...
  onStart: async function ({ message, api, event, usersData, threadsData }) {
    ...
    const authorName = "A Y A N";
    const authorFB = "https://www.facebook.com/ayan.alvi.6";
    const authorInsta = "https://www.instagram.com/ayan.alvi.1";
    const authorEmail = "👀";
    const authorGithub = "https://github.com/✨";
    const status = "𝙎𝙞𝙣𝙜𝙡𝙚";
    const timeStart = Date.now();

    const urls = JSON.parse(fs.readFileSync('scripts/cmds/ayan/info.json'));
